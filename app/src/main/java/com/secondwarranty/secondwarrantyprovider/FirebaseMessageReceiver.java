...
public class FirebaseMessageReceiver extends FirebaseMessagingService {
    ...
    private final String ADMIN_CHANNEL_ID = "second_warranty_provider_channel";
    ...
    private void setupChannels(NotificationManager notificationManager) {
        ...
        String adminChannelName = "Second Warranty Provider notification";
...
//    }
    ...
    private void showNotification(String title, String message){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            String adminChannelName = "Second Warranty Provider";
            String adminChannelDescription = "Device to device notification";

            NotificationChannel adminChannel = new NotificationChannel(ADMIN_CHANNEL_ID, adminChannelName,
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(),
                ADMIN_CHANNEL_ID)
                .setSmallIcon(R.drawable.sw_new)
                .setAutoCancel(true)
                ...
                .setColor(i)
                .setColorized(true)
                .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.sw_new))
