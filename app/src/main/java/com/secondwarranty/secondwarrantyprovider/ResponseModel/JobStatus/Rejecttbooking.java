...
public class Rejecttbooking {
    ...
    public Integer getHappyCode() {
        return happyCode;
    }

    public void setHappyCode(Integer happyCode) {
        this.happyCode = happyCode;
    }
