...
public class MyearningsDatum {
    ...
    public MyearningsDatum(Long orderId, String sequenceOrderId, Long usersId, String serviceType, String minCharge, Long subCategoryId, String subCategoryName, Long categoryId, String categoryName, Integer orderStep, String paymentStatus, String orderAssigned, String paymentMode, String orderStatus, String status, Integer creationDate, Integer scheduleDate, Boolean scheduleTime, String address, String currentLocation, String landmark, Long providerId, Integer assignedDate, String usersName, String usersEmail, Long usersMobile, String date, String time) {
